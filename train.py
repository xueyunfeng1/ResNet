...
def main():
    ...
    data_transform = {
        ...
        "train": transforms.Compose([
            ...
            # 即将shape为(H, W, C)的img转为shape为(C, H, W)的tensor。通道C放在了前面。
            transforms.ToTensor(),
    ...
    # 把字典编码成json格式，indent后面参数代表。。可以理解为换4次行
    ...
    # train_steps代表所有的数据被分成了这么多份， train_steps * batch_size = train_data_size(eg. 3306 / 16 = 207）
